...
//splice -> manipulate(modifies) the original array 
const ar2 = orga.splice(1,3)
console.log(orga);      //only print which are notincluded
console.log(ar2);

//spredopertaor -> used to combine arrays 
console.log("using spredoperator : " + [...arr, ...orga]);

//flat -> used to join the all arrays and return new array (flatten nested arrays)
